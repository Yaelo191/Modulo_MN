...
def metodo_newton(def_funcion, def_funcion_prime, P0=1, tolerancia=1e-05, max_iter=10000):
    """
    Metodo de newton
    In:
    ...
    Out:
    imprime las raices encontradas o indica que alcanzo el maxmo de iteraciones
    """
    iteracion = 1  
