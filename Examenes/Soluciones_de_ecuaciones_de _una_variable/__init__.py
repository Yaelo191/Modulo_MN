from .Soluciones_de_ecuaciones_de_una_variable.bisec import metodo_biseccion
...
from .Soluciones_de_ecuaciones_de_una_variable.pto_fijo import metodo_pto_fijo